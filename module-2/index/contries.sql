...
(
    (ARRAY[
        'Aru','Bel','Cas','Dor','El','For','Gal','Hel','Indo','Jor','Kor',
        'Lumi','Mon','Nor','Oro','Per','Qua','Rava','Sol','Tor','Ura',
        'Val','Wesi','Xan','Yaro','Zan'
    ])[floor(random() * 27)::int + 1]
    ||
    (ARRAY[
        'ia','land','stan','eria','aria','ora','esia','ania','ara','oria'
